        ...
        ScrollView:
            MDBoxLayout:
                ...
                MDTextField:
                    ...
                    readonly: True
                    on_touch_down:
                        if self.collide_point(*args[1].pos): root.building_picker()
                    text_color_normal: 1, 1, 1, 1
                    text_color_focus: 1, 1, 1, 1
                    line_color_normal: 1, 1, 1, 1
                    line_color_focus: 1, 1, 1, 1
                ...
                MDTextField:
                    ...
                    mode: "rectangle"
                    on_touch_down:
                        if self.collide_point(*args[1].pos): root.day_picker()
                    text_color_normal: 1, 1, 1, 1
                    text_color_focus: 0, 0, 0, 1
                    line_color_normal: 1, 1, 1, 1
                    line_color_focus: 1, 1, 1, 1
                ...
                MDBoxLayout:
                    ...
                    MDTextField:
                        ...
                        mode: "rectangle"
                        on_touch_down:
                            if self.collide_point(*args[1].pos): root.show_start_time()
                        text_color_normal: 1, 1, 1, 1
                        text_color_focus: 0, 0, 0, 1
                        line_color_normal: 1, 1, 1, 1
                        line_color_focus: 1, 1, 1, 1
                    ...
                    MDTextField:
                        ...
                        mode: "rectangle"
                        on_touch_down:
                            if self.collide_point(*args[1].pos): root.show_end_time()
                        text_color_normal: 1, 1, 1, 1
                        text_color_focus: 0, 0, 0, 1
                        line_color_normal: 1, 1, 1, 1
                        line_color_focus: 1, 1, 1, 1
